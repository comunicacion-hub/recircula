...
function entregaFromFS(d) {
  const o = {
    ...
    'CI/RUC':               d.ci_ruc || '',
    'Actividad Fuente':     Array.isArray(d.actividad_fuente) ? d.actividad_fuente : (d.actividad_fuente ? [d.actividad_fuente] : []),
    'Voucher':              d.voucher || '',
...
function entregaToFS(data) {
  const f = {
    ...
    ci_ruc:               data['CI/RUC'] || '',
    actividad_fuente:     Array.isArray(data['Actividad Fuente']) ? data['Actividad Fuente'] : (data['Actividad Fuente'] ? [data['Actividad Fuente']] : []),
